...
const Detail = () => {
    ...
    return (
        <div classNam="card h-100 mt-5 mb-5">
            <img src={singleSeviceDetail?.img} className="card-img-top single-service-img" alt="..." />
            <div className="card-body">
                ...
                <p className="card-text">{singleSeviceDetail?.description}</p>
                ...
                <h5 className="text-primary">Cost: ${singleSeviceDetail?.visitAmmount}</h5>
